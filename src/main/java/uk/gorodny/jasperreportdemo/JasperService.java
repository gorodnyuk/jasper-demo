...
public class JasperService {
    ...
    public JasperPrint generateReport(Man man) throws JRException, FileNotFoundException {
        ...
        return JasperFillManager.fillReport(jasperReport, params, jrBeanCollectionDataSource);
    }
}
